...
class _CreateExpenseScreenState extends State<CreateExpenseScreen> {
  ...
  void _submit() async {
    ...
    if (nameCtrl.text.isEmpty) {
      return DialogHelper.showWarning(context, "Nhập tên người nhận");
    }
  ...
  Future<void> _fillDemoData() async {
    ...
    if (firstHouse != null) {
      ...
      if (mounted && rooms.isNotEmpty) {
        setState(() => selectedRoom = rooms.first);
      }
    }
  }
                ...
                AppSectionCard(
                  ...
                  child: Column(
                    children: [
                      CustomSelectField(
                        ...
                        onTap: () {
                          AppSelectModal.show<int>(
                            context: context,
                            title: "CHỌN NHÀ TRỌ",
                            subtitle: "Vui lòng chọn khu trọ lập phiếu chi",
                            items: houses
                                .map(
                                  (h) => AppSelectItem(
                                    label: h.houseName,
                      ...
                      CustomSelectField(
                        label: "Phòng (Nếu chi cho phòng)",
                        value: selectedRoom?.roomName ?? "Chọn phòng (nếu có)",
                        onTap: () {
                          if (selectedHouse == null) {
                ...
                AppSectionCard(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomSelectField(
                        label: "Ngày chi",
                        value: DateFormat('dd/MM/yyyy').format(expenseDate),
                        onTap: () async {
                      ...
                      CustomTextField(
                        ...
                        hint: "Sửa chữa, Hủy cọc...",
                      ),
                      CustomTextField(
                        controller: descCtrl,
                        label: "Ghi chú/Nội dung chi",
                        hint: "Lý do chi tiền...",
                        maxLines: 2,
                      ),
                    ],
